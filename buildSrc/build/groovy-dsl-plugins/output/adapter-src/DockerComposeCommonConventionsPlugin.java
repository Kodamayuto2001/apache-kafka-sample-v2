...
/**
 * Precompiled docker-compose-common-conventions script plugin.
 **/
public class DockerComposeCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_DockerComposeCommonConventions").asSubclass(BasicScript.class);
